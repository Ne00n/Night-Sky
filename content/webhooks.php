...
<?php include 'content/navbar.php'; ?>
            ...
            <div class="form-group">
              <div class="col-sm-8 col-sm-offset-2">
                ...
                <span class="fa fa-pencil"></span>
                  ...
                  <input value="<?php echo Page::escape($WH->getName()); ?>" type="text" class="form-control input-sm" name="name" placeholder="Tracer">
                </div>
              </div>
            </div>
            <div class="form-group">
  ...
  <?php } ?>
      ...
      <div class="form-group">
        <a href="index.php?p=webhook?add"><button class="btn btn-primary" type="button">Add a WebHook</button></a>
      </div>
